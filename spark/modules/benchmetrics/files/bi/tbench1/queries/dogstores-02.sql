SELECT (CASE WHEN SUM(`store_sales`.`ss_net_paid`) = 0 THEN NULL ELSE SUM(`store_sales`.`ss_net_profit`) / SUM(`store_sales`.`ss_net_paid`) END) AS `sum_calculation_270497503514808329_ok`,

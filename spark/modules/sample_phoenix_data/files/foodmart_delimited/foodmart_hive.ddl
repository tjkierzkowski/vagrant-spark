...
location '${LOCATION}/sales_fact_1997';
...
row format delimited fields terminated by '\011'
location '${LOCATION}/sales_fact_1998';
...
row format delimited fields terminated by '\011'
location '${LOCATION}/sales_fact_dec_1998';
...
row format delimited fields terminated by '\011'
location '${LOCATION}/inventory_fact_1997';
...
row format delimited fields terminated by '\011'
location '${LOCATION}/inventory_fact_1998';
...
row format delimited fields terminated by '\011'
location '${LOCATION}/agg_pl_01_sales_fact_1997';
...
row format delimited fields terminated by '\011'
location '${LOCATION}/agg_ll_01_sales_fact_1997';
...
row format delimited fields terminated by '\011'
location '${LOCATION}/agg_l_03_sales_fact_1997';
...
row format delimited fields terminated by '\011'
location '${LOCATION}/agg_l_04_sales_fact_1997';
...
row format delimited fields terminated by '\011'
location '${LOCATION}/agg_l_05_sales_fact_1997';
...
row format delimited fields terminated by '\011'
location '${LOCATION}/agg_c_10_sales_fact_1997';
...
row format delimited fields terminated by '\011'
location '${LOCATION}/agg_c_14_sales_fact_1997';
...
row format delimited fields terminated by '\011'
location '${LOCATION}/agg_lc_100_sales_fact_1997';
...
row format delimited fields terminated by '\011'
location '${LOCATION}/agg_c_special_sales_fact_1997';
...
row format delimited fields terminated by '\011'
location '${LOCATION}/agg_g_ms_pcat_sales_fact_1997';
...
row format delimited fields terminated by '\011'
location '${LOCATION}/agg_lc_06_sales_fact_1997';
...
row format delimited fields terminated by '\011'
location '${LOCATION}/employee_closure';
...
row format delimited fields terminated by '\011'
location '${LOCATION}/expense_fact';
...
row format delimited fields terminated by '\011'
location '${LOCATION}/product_class';
...
row format delimited fields terminated by '\011'
location '${LOCATION}/reserve_employee';
...
row format delimited fields terminated by '\011'
location '${LOCATION}/store_ragged';
...
row format delimited fields terminated by '\011'
location '${LOCATION}/warehouse_class';
